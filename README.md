...
FX HTML TT + interest-rates HTML + card offer-cards.
...
Research staged in [ArdenoStudio/lankawa](https://github.com/ArdenoStudio/lankawa) `api-docs/packages/peoples-bank-rates-docs/`. Source docs:
...
- Python: [`python/`](./python/) — `peoples-bank-rates-docs-unofficial` (`pip install -e .`)
- TypeScript: [`typescript/`](./typescript/) — `@cookie-cat21/peoples-bank-rates-docs-client`
