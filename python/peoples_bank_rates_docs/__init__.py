"""Minimal unofficial HTTP client for People's Bank Rates.
...
DEFAULT_UA = "peoples-bank-rates-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/peoples-bank-rates-docs; educational; polite)"
DEFAULT_BASE = "https://www.peoplesbank.lk"


class PeoplesBankRatesDocsClient:
    """Unofficial client — People's Bank Rates."""
    ...
    def __enter__(self) -> "PeoplesBankRatesDocsClient":
        return self
    ...
    def interest_rates_html(self, **kwargs: Any) -> Any:
    ...
    def offer_cards(self, **kwargs: Any) -> Any:
